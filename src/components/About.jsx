      ...
      <div className="relative z-10 max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-16">
        ...
        >
          ...
          >
            ...
            <span className="font-semibold text-purple-600 dark:text-yellow-300">
              MERN Stack
            </span>{" "}
            and mentor students to enter tech with confidence.
          </motion.p>
          ...
          >
            B.E Computer Science — Arunai Engineering college, Tiruvanamalai.
          </motion.p>
